...
exp_name = "SRResNet_CoBi_x4-DIV2K"
...
if mode == "train":
    ...
    pretrained_model_weights_path = f"./results/pretrained_models/SRResNet_x4-ImageNet-19d98e7.pth.tar"
...
if mode == "test":
    ...
    model_weights_path = "./results/pretrained_models/SRResNet_CoBi_x4-DIV2K-6dd5216c.pth.tar"
