...
def load_dataset() -> [CUDAPrefetcher, CUDAPrefetcher]:
    ...
    train_datasets = PairedImageDataset(srgan_config.train_gt_images_dir, srgan_config.train_lr_images_dir)
    test_datasets = PairedImageDataset(srgan_config.test_gt_images_dir, srgan_config.test_lr_images_dir)
...
def define_loss() -> [nn.L1Loss,
    ...
    cobi_rgb_criterion = model.contextual_bilateral_loss_for_rgb(
        ...
        patch_size=srgan_config.patch_size,
        stride=srgan_config.stride,
        weight_spatial=srgan_config.weight_spatial,
...
def train(
    ...
    while batch_data is not None:
        ...
        gt, lr = imgproc.random_crop_torch(gt, lr, srgan_config.gt_image_size, srgan_config.upscale_factor)
        gt, lr = imgproc.random_rotate_torch(gt, lr, srgan_config.upscale_factor, [0, 90, 180, 270])
